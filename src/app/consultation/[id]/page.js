// app/consultation/[id]/page.js - COMPLETE CENTERED VERSION
'use client';
...
export default function ConsultationViewPage() {
	...
	// Load consultation and patient data with better error handling
	useEffect(() => {
				...
				<div className="atlas-page-container">
					<div className="atlas-content-wrapper">
						<div className="flex justify-center items-center min-h-64">
							...
							<span className="ml-3 text-gray-600">Loading consultation...</span>
						</div>
					</div>
				</div>
			</div>
	...
	return (
		<div className="atlas-backdrop">
			<div className="atlas-page-container">
				<div className="atlas-content-wrapper print:p-4">
					...
					{showMetadata && (
						<Card className="atlas-card-secondary mb-6 print:hidden">
							<CardHeader>
